...
export class Movie1602711200387 implements MigrationInterface {
    name = 'Movie1602711200387'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "rent" ("id" BIGSERIAL NOT NULL, 
        ...
        await queryRunner.query(`CREATE TABLE "movie_rent" ("id" SERIAL NOT NULL, 
        "quantity" integer NOT NULL, 
        "movieId" bigint NOT NULL, 
        "rentId" bigint NOT NULL, 
        CONSTRAINT "PK_0d97199759e16ecf213674ddbb5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "movie" ("id" BIGSERIAL NOT NULL, 
        "title" text NOT NULL, 
